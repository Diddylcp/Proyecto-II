...
public class TutorialHotKeySystem : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.W) && newHotKeys)
        {
            clickSound.Play();
            if (warriorHotKey || mageHotKey || archerHotKey)
            {
        ...
        else if (Input.GetKeyDown(KeyCode.E) && newHotKeys)
        {
            clickSound.Play();
            if (warriorHotKey || mageHotKey || archerHotKey)
            {
